...
20.times {print '-'}
puts
puts 'What would you like to do? Enter 1) for Addition, 2) for Subtraction, 3) for Division, 4) for Mutliplication. To exit, type X'
input = gets.chomp.upcase

while input != ('1' or '2' or '3' or '4' or 'X')
  puts 'Invalid Entry. Please use one of the options given'
  input = gets.chomp.upcase
